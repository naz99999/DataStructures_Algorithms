...
public class StudentMedium {
    public static void main(String[] args) throws Exception {
        List<Student> list = Arrays.asList(
                ...
                new Student(9, "Sonu", "Shankar", 27, "Female", "Computer Engineering", 2018, "Karnataka", 9),
                new Student(10, "Shubham", "Pandey", 26, "Male", "Instrumentation Engineering", 2017, "Mumbai", 98),
                new Student(11, "Naman", "Bindra", 56, "Male", "Computer Engineering", 2018, "Delhi", 7));

        System.out.println(4);
        list.stream()
                .filter(student -> student.getFirstName().substring(0, 1).equals("A")).forEach(s -> System.out.println(s.getFirstName()));
        //System.out.println(list1);

        list.stream()
                .filter(student -> student.getFirstName().endsWith("y")).forEach(s -> System.out.println(s.getFirstName()));
        ...
        list.stream().filter(s -> s.getAge() < 30).forEach(s ->  System.out.println(s));
        ...
        Map.Entry<String, Long> maxCountDepartment = list.stream()
                        .collect(Collectors.groupingBy(Student::getDepartmantName, Collectors.counting()))
                        .entrySet().stream()
        ...
        Student secondRank2 = list.stream()
                .sorted(Comparator.comparing(Student::getRank).reversed())
                .skip(1)
                .findFirst()
                        .get();
        System.out.println(secondRank2);

        Double d = 0d;
        System.out.println(d);

        Optional<String> str = Optional.of("pop");
